...
public class ColorPattern {
	...
	private void initSettingsFromXML(String pattern_xml_file) {
		Node root_node = null;
		Document xml_document = MetaXMLHelper.openXMLFile(pattern_xml_file);
		...
		pattern_type = MetaXMLHelper.getStringParam(root_node, "type");
		base_scale = MetaXMLHelper.getDoubleParam(root_node, "scale", base_scale);
		primary_template_color = MetaXMLHelper.getColorParam(root_node, "color_primary", primary_template_color);
		secondary_template_color = MetaXMLHelper.getColorParam(root_node, "color_secondary", secondary_template_color);
		
		String bodyparts_only = MetaXMLHelper.getStringParam(root_node, "bodyparts_only");
	...
	public static void loadPatterns(Map<String, ColorPattern> patterns_var, String from_dir) {
		patterns_var.clear();
		String[] pattern_meta_files = MetaXMLHelper.getDirMetaXML(from_dir);
